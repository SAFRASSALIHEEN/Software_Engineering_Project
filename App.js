      ...
      <div className="log-in-1 screen">
        <div className="overlap-group2">
          ...
          <h1 className="faculty-of-engineeri inter-bold-cod-gray-48px">
            FACULTY OF ENGINEERING <br /> UNIVERSITY OF JAFFNA
          </h1>
        ...
        <div className="overlap-group">
          ...
          <p className="faculty-of-engineeri inter-bold-cod-gray-48px">
            FACULTY OF ENGINEERING <br /> UNIVERSITY OF JAFFNA
          </p>
          ...
          <div className="phone inter-medium-black-14px">+94-021-2062161</div>
...
function LogInButton(props) {
  ...
  return (
    <div className="log-in-button">
      <div className="log-in inter-medium-cod-gray-22px">{children}</div>
    </div>
  );
}
